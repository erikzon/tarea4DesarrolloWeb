...
<body class="d-flex flex-column min-vh-100">
        ...
        <section class="my-1 mx-3">
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr data-estudiante='<?php echo e(json_encode($estudiante)); ?>' class="selectable-row">
                        <td><?php echo e($estudiante->carne); ?></td>
                        <td><?php echo e($estudiante->nombres); ?></td>
                        <td><?php echo e($estudiante->apellidos); ?></td>
                        <td><?php echo e($estudiante->direccion); ?></td>
                        <td><?php echo e($estudiante->telefono); ?></td>
                        <td><?php echo e($estudiante->correo_electronico); ?></td>
                        <td><?php echo e($estudiante->fecha_nacimiento); ?></td>
                        <td><?php echo e($estudiante->sangre); ?></td>
                    </tr>
    ...
    <section>
        <footer class="bg-dark text-light text-center py-3">
            <div class="container">
                <p>Carné: 7691-19-11984 || Nombre: Victor Hugo Guerra Rodriguez. <br> UMG, pagina realizada con PHP
                    (Laravel), octavo semestre &copy; 2023 Todos los derechos reservados.</p>
            </div>
        </footer>
    </section>
    ...
    <section>
        <script>
            const hostPort = "<?php echo e($hostPort); ?>"
            const hostDirection = "<?php echo e($hostDirection); ?>"
...
</html><?php /**PATH /home/victor/U/tarea4/resources/views/tabla.blade.php ENDPATH**/ ?>